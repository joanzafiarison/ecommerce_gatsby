  ...
  return (
    ...
    <div style={{margin : "7rem"}}>
        ...
        <p>Vous trouverez ci-après un modèle de conditions générales de vente libre et gratuit que vous pouvez réutiliser à condition simplement de faire un lien vers ce post (ce qui permettra aux personnes qui les lisent de retrouver le modèle originel et ses évolutions).
          ...
          Vous pouvez également télécharger WP-CGV qui est un plug-in qui automatise tout (si vous utilisez WordPress…) !</p>
        <p>
        ...
        <p>La société peut être jointe par email en cliquant sur le formulaire de contact accessible via la page d’accueil du site.
        ...
        NOTE: On indique ici les premiers éléments obligatoires du contrat à savoir : l’identification précise du vendeur – obligations imposées notamment par l’article 6 de la LCEN (sanctions 1 an d’emprisonnement et 75.000€ d’amende à défaut), l’article 19 de la LCEN, les articles L111-1 et s. du Code de la conso… Il est également obligatoire de fournir un point de contact (LCEN art. 6).
        </p>
        <p>
        PREAMBULE
        ...
        <p style={{textAlign:"justify"}}>Les présentes Conditions Générales de Vente déterminent les droits et obligations des parties dans le cadre de la vente en ligne de Produits ou Services proposés par le Vendeur.
        ...
        NOTE TRES IMPORTANTE : – on détaille le prix de vente de manière précise (attention sanctions de ce côté la JP est très sévère) – on précise l’ensemble des éléments relatifs à la livraison (qui ne sont pas précisés dans ces CGV car elles sont, à l’origine, destinées à des produits immatériels).
        </p>
        
        <h2>Article 3.1 : Prix</h2> 
        <p> exemple de clause illicite La Société se réserve la possibilité de changer les prix à tout moment des produits achetés par le consommateur en particulier pour les abonnements – ceux-ci seront librement déterminés par le Vendeur par la suite, au fur et à mesure de l'évolution des prestations.
        ...
        <p>  Le cas échéant, l’Acheteur peut présenter toute réclamation en contactant la société au moyen des coordonnées suivantes (indiquer les coordonnées et la procédure).
        ...
        NOTE: On rappelle ici simplement que la vente n’occasionne aucune cessions d’IP.
        </p>
        <h2>Article 16 : Force majeure</h2> 
        <p>L’exécution des obligations du vendeur au terme des présentes est suspendue en cas de survenance d’un cas fortuit ou de force majeure qui en empêcherait l’exécution. Le vendeur avisera le client de la survenance d’un tel évènement dès que possible.
        NOTE: Clause type classique
        </p>
        <h2>Article 17 : Nullité et modification du contrat </h2>
        <p> Si l’une des stipulations du présent contrat était annulée, cette nullité n’entraînerait pas la nullité des autres stipulations qui demeureront en vigueur entre les parties. Toute modification contractuelle n’est valable qu’après un accord écrit et signé des parties.
        NOTE: Clause classique de gestion de la nullité éventuelle du contrat
        </p>
        ...
        NOTE: informations relatives au respect du RGPD
        </p>
        ...
        NOTE: Idem, clause classique permettant de gérer le droit applicable.
        </p>
